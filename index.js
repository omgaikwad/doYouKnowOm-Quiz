...
console.log(
  "Lets play do you know Om? quiz! I will ask 5 questions related to me and you will get two options to choose answer from."
);
console.log(
  "Type '1' to choose first option or type '2' to choose second option"
);
...
question1 = {
  question:
    "In which board did I studied in my school? 1-State Board 2-CBSE Board: ",
  answer: "1",
};
...
question4 = {
  question:
    "Which is my favourite sitcom tv show? 1-Friends 2-Big Bang Theory: ",
  answer: "1",
};
